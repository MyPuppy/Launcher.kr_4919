    ...
    public static class GameSupport
    {
        ...
        public static void PrQuestUX2ndPacket()
        {
            ...
            using (OutPacket outPacket = new OutPacket("PrQuestUX2ndPacket"))
            {
                ...
                //questGroupIndex='1'
                outPacket.WriteInt(105000401);
                outPacket.WriteInt(105000401);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(105000402);
                outPacket.WriteInt(105000402);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(105000403);
                outPacket.WriteInt(105000403);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                //questGroupIndex = '2'
                outPacket.WriteInt(205010001);
                outPacket.WriteInt(205010001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(205020001);
                outPacket.WriteInt(205020001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(205030001);
                outPacket.WriteInt(205030001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(205040001);
                outPacket.WriteInt(205040001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                //questGroupIndex='3'
                outPacket.WriteInt(305010001);
                outPacket.WriteInt(305010001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(305020001);
                outPacket.WriteInt(305020001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(305030001);
                outPacket.WriteInt(305030001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(305040001);
                outPacket.WriteInt(305040001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(305050001);
                outPacket.WriteInt(305050001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                outPacket.WriteInt(305060001);
                outPacket.WriteInt(305060001);
                outPacket.WriteHexString("00 00 00 00 FF FF 00 00 00 00 00 00 00 00 00 00 02 00 00 00 00 00 00 00 00");
                RouterListener.MySession.Client.Send(outPacket);
            }
